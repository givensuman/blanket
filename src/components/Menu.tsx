...
import {
    ...
    ModalBody,
    ModalCloseButton,
    useColorMode, useColorModeValue, useDisclosure, Link
        ...
        <_Menu>
            ...
            <MenuList>
                <Item
                    ...
                    label={`Switch to ${colorMode === "light"
                        ? "dark mode"
                        : "light mode"
                    }`}
                ...
                <Item
                    icon={<GitBranch />}
                    label="View codebase"
                    onClick={() => window.open("https://www.github.com/givensuman/blanket", "_blank")}
                />
            </MenuList>
        </_Menu>
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
                ...
                <ModalBody>
                    ...
                    <p>
                        For information on sound licensing, go <span>
                            <Link 
                                color={linkColor} 
                                href="#"
                            >
                ...
                <Button 
                    variant="ghost"
                    onClick={() => window.open("https://github.com/rafaelmardojai/blanket", "_blank")}
                >
                    Get GNOME app
                </Button>
                </ModalFooter>
